...
We are going to write a program that randomly selects a line from `rad.csv` above and prints it out in some human-readable way. In the process of writing this we will see a few new features. Throw this code into`fun_fact.awk`:
