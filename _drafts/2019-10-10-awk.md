...
AWK is a [Turing-complete](https://en.wikipedia.org/wiki/Turing_completeness) language. So let's learn it.
...
Hey, look at that, comments. Also, we generated a random number between 0.0 and 1.0 using `rand()`. And we tried to give our code a better random seed using `srand()`.
...
One of the best things about AWK is it is such a small language. You can learn most of the standard libraries in a weekend of light puttering.

But, if you spend a little more time in AWK, and need more resources, check these out:
...
Also, just for fun, there is a simple version of DOOM written entirely in AWK on GitHub:
