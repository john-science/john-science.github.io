...
The approach I'm going to take here is to introduce each major feature of the AWK language via example. So, this will not be a complete language reference, you will find all that stuff linked at the end.
